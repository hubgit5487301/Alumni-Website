...
const job_id = new mongoose.Schema({
  job_id: {type: String, default: 'no dta'}
})

const event_id = new mongoose.Schema ({
  event_id: {type: String, default: 'no dta' }
})
