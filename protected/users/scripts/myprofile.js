...
import {upload as uploadfile, getdataonevent as getdata, updatedataonevent as updatedata, download as downloadresume} from "../../protected-scripts/util.js";
...
//     const data = await getdata(`my-profile/download-resume`);
